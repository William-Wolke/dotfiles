...
alias nvim='nvim'
alias c='clear'
alias ccom='bash ~/edaider/misc-scripts/ChooseCommandUtility.sh'
alias docex='bash ~/edaider/misc-scripts/DockerExecUtility.sh'
alias lint='bash ~/edaider/misc-scripts/lint-all.sh'
alias prettify='bash ~/edaider/misc-scripts/prettify-all.sh'
